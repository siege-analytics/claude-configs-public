...
In standing-order or backlog-drain goal mode, transition announcements are future-action claims. A line like "continuing now," "I'll inspect the next issue," or "watching release" requires the same-turn action or re-entry mechanism. Without that artifact, it is a false commitment and must be replaced by the action itself or a blocker statement.
