...
- Rules 7-12, 14, 16, 17, 18 (structural): require judgment about test fidelity, cargo-culted patterns, speculative abstractions, symbol existence, scope-of-fix, dependency reachability, public-surface diffs, mock fidelity, doc-edit symmetry, and silent error swallowing. These belong in `[`code-review`](../code-review/SKILL.md)` and (for rule 12) `[`commit`](../commit/SKILL.md)` step 4 (the affected-tests gate).
