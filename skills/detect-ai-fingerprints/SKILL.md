...
description: "Mechanical scanner for stylistic AI fingerprints (rules 1-6 of [`no-ai-fingerprints`](../_no-ai-fingerprints-rules.md)) in staged diffs, working-tree diffs, GitHub PR diffs, or commit/PR message bodies. Reports file:line violations and a 0/1 exit code. Structural rules 7-11 require [`code-review`](../code-review/SKILL.md) judgment and are not in scope."
...
scanned with rules 1-6 of [`no-ai-fingerprints`](../_no-ai-fingerprints-rules.md); rules 7-11 require [`code-review`](../code-review/SKILL.md) judgment.
violations: 4
```
...
- Rules 7-11 (structural): require judgment about test fidelity, cargo-culted patterns, speculative abstractions, symbol existence, and scope-of-fix. These belong in `[`code-review`](../code-review/SKILL.md)`.
...
clean (rules 1-6); rules 7-11 still require [`code-review`](../code-review/SKILL.md) judgment.
$ echo $?
0
```
