...
- [`shelves--effective-python`](../shelves/languages/effective-python/SKILL.md) -- Pythonic structure.
- [`shelves--using-asyncio-python`](../shelves/languages/using-asyncio-python/SKILL.md) -- async patterns.
- [`shelves--clean-code`](../shelves/engineering-principles/clean-code/SKILL.md) -- DRY, function discipline.
- [`shelves--design-patterns`](../shelves/engineering-principles/design-patterns/SKILL.md) -- GoF in Python.
