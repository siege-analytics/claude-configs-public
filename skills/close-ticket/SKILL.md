...
3. Review the ticket's full history before closing
   ...
   4. Verify `[`ticket-lifecycle`](../_ticket-lifecycle-rules.md)` Done evidence: merge/target branch, deployment/release or N/A, and testing/UAT/production validation or N/A
