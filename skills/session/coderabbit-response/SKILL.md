...
For each FIXed thread, ask: "is this a recurring pattern, or a one-off?" If recurring (you've seen it before in this repo, or it points at a project-wide invariant), invoke [`lessons-learned`](../../meta/lessons-learned/SKILL.md) to log or bump the corresponding entry in `LESSONS.md`.
