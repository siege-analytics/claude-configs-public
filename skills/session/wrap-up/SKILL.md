...
This is **not a blocker** — the user decides whether to run [`rules-audit`](../../meta/rules-audit/SKILL.md). The nudge just ensures the question gets asked.
...
For each pattern that qualifies, invoke [`lessons-learned`](../../meta/lessons-learned/SKILL.md) to append or bump the entry. Threshold guidance:
...
- [ ] LESSONS.md ledger updated for any recurring patterns surfaced this session (via [`lessons-learned`](../../meta/lessons-learned/SKILL.md))
