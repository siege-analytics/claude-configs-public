...
The parent discipline is `[`verify-before-execute`](_verify-before-execute-rules.md)` Evidence clause: same-turn tool calls back factual claims. These four rules are specific shapes of that discipline applied at claim time.
