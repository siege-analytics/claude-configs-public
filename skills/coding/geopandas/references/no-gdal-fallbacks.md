...
2. **DuckDB-spatial** ([`duckdb-spatial`](../../../coding/duckdb-spatial/SKILL.md)) — bundles its own GEOS; reads/writes Parquet without GDAL; provides ST_* operations at SQL level. The strongest single tool for GDAL-less spatial work.
