...
- **DuckDB-spatial** ([`duckdb-spatial`](../../../coding/duckdb-spatial/SKILL.md)) — single-node, in-memory + spilling, very fast
- **Sedona** ([`sedona`](../../../coding/sedona/SKILL.md)) — distributed across a Spark cluster
