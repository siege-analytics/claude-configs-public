...
| Data > 5 GB or persistent multi-user reads | **PostGIS** ([`postgis`](../../coding/postgis/SKILL.md)) |
| Data > RAM, distributed compute available | **Sedona** ([`sedona`](../../coding/sedona/SKILL.md)) |
| You have parquet, want SQL, no server | **DuckDB-spatial** ([`duckdb-spatial`](../../coding/duckdb-spatial/SKILL.md)) |
