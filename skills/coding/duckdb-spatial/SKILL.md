...
|---|---|
| Persistent multi-user query workload | **PostGIS** ([`postgis`](../../coding/postgis/SKILL.md)) |
| Pandas-style operations, lots of joins with non-spatial dataframes | **GeoPandas** ([`geopandas`](../../coding/geopandas/SKILL.md)) |
| Data > one machine's RAM × 4 (DuckDB spills but eventually fails) | **Sedona on Spark** ([`sedona`](../../coding/sedona/SKILL.md)) |
...
- [`sql`](../../coding/sql/SKILL.md) — DuckDB is SQL-first
- [`python`](../../coding/python/SKILL.md) — when scaffolding via `import duckdb`
