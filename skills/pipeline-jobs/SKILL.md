...
- [`shelves--data-pipelines`](../shelves/data-and-pipelines/data-pipelines/SKILL.md) -- ingestion, scheduling, observability patterns.
- [`shelves--clean-architecture`](../shelves/engineering-principles/clean-architecture/SKILL.md) -- separate orchestration from transformation.
