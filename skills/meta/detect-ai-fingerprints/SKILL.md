...
description: "Mechanical scanner for stylistic AI fingerprints (rules 1-6 of [`no-ai-fingerprints`](../../_no-ai-fingerprints-rules.md)) in staged diffs, working-tree diffs, GitHub PR diffs, or commit/PR message bodies. Reports file:line violations and a 0/1 exit code. Structural rules 7-11 require [`code-review`](../../coding/code-review/SKILL.md) judgment and are not in scope."
...
scanned with rules 1-6 of [`no-ai-fingerprints`](../../_no-ai-fingerprints-rules.md); rules 7-11 require [`code-review`](../../coding/code-review/SKILL.md) judgment.
violations: 4
```
...
- Rules 7-12, 14, 16, 17, 18 (structural): require judgment about test fidelity, cargo-culted patterns, speculative abstractions, symbol existence, scope-of-fix, dependency reachability, public-surface diffs, mock fidelity, doc-edit symmetry, and silent error swallowing. These belong in `[`code-review`](../../coding/code-review/SKILL.md)` and (for rule 12) `[`commit`](../../git-workflow/commit/SKILL.md)` step 4 (the affected-tests gate).
...
clean (rules 1-6); rules 7-11 still require [`code-review`](../../coding/code-review/SKILL.md) judgment.
$ echo $?
0
```
...
- `[`no-ai-fingerprints`](../../_no-ai-fingerprints-rules.md)` is the rule this skill enforces. Rules 1-6 are mechanically scanned; rules 7-11 are not.
