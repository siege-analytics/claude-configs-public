...
- Rules 7-11 (structural): require judgment about test fidelity, cargo-culted patterns, speculative abstractions, symbol existence, and scope-of-fix. These belong in `[`code-review`](../../coding/code-review/SKILL.md)`.
