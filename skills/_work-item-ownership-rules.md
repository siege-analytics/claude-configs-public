...
- `[`tandem-agent`](_tandem-agent-rules.md)` -- role contracts, review-only boundaries, explicit authorization, active collaborator supervision, durable findings, and re-review gates for tandem work.
