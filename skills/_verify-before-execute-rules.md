...
- **`[`commit`](commit/SKILL.md)`** invokes verify-before-execute as part of its step 0.5 (before staging review). The rule is broader than commits; the commit skill is one consumer.
