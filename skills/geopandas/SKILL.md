...
| Data > 5 GB or persistent multi-user reads | **PostGIS** ([`postgis`](../postgis/SKILL.md)) |
| Data > RAM, distributed compute available | **Sedona** ([`sedona`](../sedona/SKILL.md)) |
| You have parquet, want SQL, no server | **DuckDB-spatial** ([`duckdb-spatial`](../duckdb-spatial/SKILL.md)) |
