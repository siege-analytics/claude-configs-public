...
| Data > 5 GB or persistent multi-user reads | **PostGIS** ([`postgis`](../postgis/SKILL.md)) | [PROVEN] |
| Data > RAM, distributed compute available | **Sedona** ([`sedona`](../sedona/SKILL.md)) | [RECOMMENDED] |
| You have parquet, want SQL, no server | **DuckDB-spatial** ([`duckdb-spatial`](../duckdb-spatial/SKILL.md)) | [EXPERIMENTAL] |
...
Per [`siege-utilities`](../_siege-utilities-rules.md), check SU first. For spatial Python work specifically, SU obviates:
