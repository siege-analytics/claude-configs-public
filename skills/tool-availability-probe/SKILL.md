...
- `[`writing-tests`](../_writing-tests-rules.md)` writing-tests:7 (#656) — requires the tool be named on ACs; this skill is what verifies it exists.
- `[`testing-frameworks`](../testing-frameworks/SKILL.md)` (#659) — declares the tool set (`assertion_tools` per layer) this skill probes against.
