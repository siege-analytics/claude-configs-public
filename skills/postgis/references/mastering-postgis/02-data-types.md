...
Excellent for binning at scale (hexagons aren't subject to the rectangular-grid distortion problem) and for approximate joins when full PostGIS overlay is overkill. See [`../indexing-strategies.md`](../indexing-strategies.md) and [`duckdb-spatial`](../../../duckdb-spatial/SKILL.md) (DuckDB also supports H3).
