...
- Pure performance infrastructure (caching tiers, load balancing, Varnish,
  horizontal scaling) -- see [`shelves--high-performance-django`](../../../shelves/django/high-performance-django/SKILL.md)
- Rescuing a legacy codebase that did not follow these practices -- see
  [`shelves--django-design-patterns`](../../../shelves/django/django-design-patterns/SKILL.md) for the rescue methodology
- Non-Django Python projects -- see [`shelves--languages`](../../../shelves/languages/SKILL.md)
...
- Distributed system design beyond Django (microservices, event sourcing,
  CQRS) -- see [`shelves--systems-architecture`](../../../shelves/systems-architecture/SKILL.md)

## Companions

- [`shelves--high-performance-django`](../../../shelves/django/high-performance-django/SKILL.md) -- after building correctly, scale it
- [`shelves--django-design-patterns`](../../../shelves/django/django-design-patterns/SKILL.md) -- legacy rescue and pattern vocabulary
- [`shelves--clean-code`](../../../shelves/engineering-principles/clean-code/SKILL.md) -- general code quality principles
- [`shelves--pragmatic-programmer`](../../../shelves/engineering-principles/pragmatic-programmer/SKILL.md) -- broader engineering discipline
- [`shelves--systems-architecture`](../../../shelves/systems-architecture/SKILL.md) (`skills/shelves/systems-architecture/data-intensive/SKILL.md`) -- database internals beyond Django's ORM
