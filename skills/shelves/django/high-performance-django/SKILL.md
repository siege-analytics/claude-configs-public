...
- Writing correct Django code (project layout, model design, form
  validation) -- see [`shelves--two-scoops-django`](../../../shelves/django/two-scoops-django/SKILL.md)
- Rescuing a structurally broken codebase -- fix correctness before
  optimizing performance; see [`shelves--django-design-patterns`](../../../shelves/django/django-design-patterns/SKILL.md)
...
- [`shelves--two-scoops-django`](../../../shelves/django/two-scoops-django/SKILL.md) -- build correctly first, then scale
- [`shelves--django-design-patterns`](../../../shelves/django/django-design-patterns/SKILL.md) -- if the codebase needs structural
  fixes before performance work is meaningful
- [`shelves--systems-architecture`](../../../shelves/systems-architecture/SKILL.md) (`skills/shelves/systems-architecture/data-intensive/SKILL.md`) -- for deeper treatment of database internals,
