...
|---|---|
| Designing an ingestion pipeline, choosing batch vs stream, scheduling, reliability | [`shelves--data-pipelines`](../../shelves/data-and-pipelines/data-pipelines/SKILL.md) |
| Storage-engine choice or distributed-data internals (load this *and* DDIA) | also [`shelves--systems-architecture`](../../shelves/systems-architecture/SKILL.md) (`skills/shelves/systems-architecture/data-intensive/SKILL.md`) |

## Books in this shelf

- [`shelves--data-pipelines`](../../shelves/data-and-pipelines/data-pipelines/SKILL.md) -- *Data Pipelines Pocket Reference* (James Densmore). Practical patterns for ingestion, transformation, scheduling, and observability.
