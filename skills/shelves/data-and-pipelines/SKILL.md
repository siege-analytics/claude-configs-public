...
|---|---|
| Designing an ingestion pipeline, choosing batch vs stream, scheduling, reliability | `skills/shelves/data-and-pipelines/data-pipelines/SKILL.md` |
...
- `skills/shelves/data-and-pipelines/data-pipelines/SKILL.md` -- *Data Pipelines Pocket Reference* (James Densmore). Practical patterns for ingestion, transformation, scheduling, and observability.
