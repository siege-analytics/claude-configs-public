...
Example: A customer spends an average of $100 per purchase, buys 4 times per year, and stays for 3 years.
LTV = $100 x 4 x 3 = $1,200

### Subscription LTV Formula

**LTV = Average Monthly Revenue per Customer / Monthly Churn Rate**

Example: Average monthly revenue is $50 and monthly churn rate is 5%.
LTV = $50 / 0.05 = $1,000
...
"You have used [feature] [X] times this month. Upgrade to [tier] to unlock [specific benefit] and [specific benefit]. See plans."

**Upgrade email:**
"Hi [Name], I noticed your team is getting great results with [feature]. Customers like you who upgrade to [tier] typically see [specific improvement]. Here is what you would get: [3 bullet benefits]. Upgrade now and we will waive the setup fee."

**Cross-sell email:**
"Hi [Name], since you are using [product A] to [achieve result], I wanted to let you know about [product B]. It works together with [product A] to [combined benefit]. [X%] of customers who use both see [specific result]."
