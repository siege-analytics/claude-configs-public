...
Do NOT silently accept the handoff. Per `[`writing-prose`](../_writing-prose-rules.md)` writing-prose:5 and `[`writing-claims`](../_writing-claims-rules.md)` writing-claims:9, "I'll drive" + no mechanism is a lie of omission.
